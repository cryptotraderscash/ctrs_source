...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(225000000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "cryptotraders";
...
const int      P2P_DEFAULT_PORT                              =  11000;
const int      RPC_DEFAULT_PORT                              =  11001;
...
const char* const SEED_NODES[] = { "140.82.27.130:11000", "149.28.109.41:11000" };
} // CryptoNote
