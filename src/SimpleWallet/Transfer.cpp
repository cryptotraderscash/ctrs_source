...
Maybe<uint64_t> getFee()
{
    while (true)
    {
        ...
        std::cout << std::endl 
                  ...
                  << std::endl
                  << "Hit enter for the default fee of 0.00001000 CTRS: ";
...
Maybe<uint64_t> getTransferAmount()
{
    while (true)
    {
        ...
        std::cout << std::endl
                  << InformationMsg("How much CTRS do you want to send?: ");
...
bool parseFee(std::string feeString)
{
    ...
    {
        std::cout << WarningMsg("Fee must be at least 0.00001000 CTRS!") << std::endl;
        return false;
    }
...
bool parseAddress(std::string address)
{
    ...
    else if (expectedPrefix == 79 && address.substr(0, 4) != "ctrs")
    {
        std::cout << WarningMsg("Invalid address! It should start with ctrs!")
                  << std::endl << std::endl;
        return false;
    }
...
bool parseAmount(std::string amountString)
{
    ...
    if (!parseAmount(amountString, amount))
    {
        std::cout << WarningMsg("Failed to parse amount! Ensure you entered "
                                "the value correctly.")
                  << std::endl
                  << "Please note, the minimum you can send is 0.00000001 CTRS,"
                  << std::endl
